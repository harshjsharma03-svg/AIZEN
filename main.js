...
async function handleMessages(sock, messageUpdate, printLog) {
    try {
        ...
        try {
            ...
            console.error('Error checOPTIMUS_PRIME access mode:', error);
...
async function handleGroupParticipantUpdate(sock, update) {
    try {
        ...
        if (action === 'add') {
            ...
            const channelId = welcomeData?.channelId || '10029Vb7Gh46F1YlLwxJ4UO0q85998@newsletter';
        ...
        if (action === 'remove') {
            ...
            const channelId = goodbyeData?.channelId || '10029Vb7Gh46F1YlLwxJ4UO0q85998@newsletter';
