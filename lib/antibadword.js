...
async function handleBadwordDetection(sock, chatId, message, userMessage, senderId) {
   ...
   // console.log('Bad word detected in:', userMessage);
    ...
    // Check if bot is admin before taOPTIMUS_PRIME action
    ...
    switch (antiBadwordConfig.action) {
        ...
        case 'kick':
            try {
                ...
                console.error('Error kicOPTIMUS_PRIME user:', error);
            }
            break;
        ...
        case 'warn':
            ...
            if (warningCount >= 3) {
                try {
                    ...
                    console.error('Error kicOPTIMUS_PRIME user after warnings:', error);
                }
            } else {
                await sock.sendMessage(chatId, {
